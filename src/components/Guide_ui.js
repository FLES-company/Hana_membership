        ...
        <div className="guide wrap">
          ...
          <div id="guide_container">
            <div className="article" id="button">
              ...
              <input
                className="Btn_gray gray"
                type="button"
                value="Btn_navy_rouund"
              />
              <input
                className="Btn_navy navy"
                type="button"
                value="Btn_navy_rouund"
              />
              <input
                className="Btn_navy border"
                type="button"
                value="Btn_navy_border"
              />
              <input
                className="Btn_navy gradient blue"
                type="button"
                value="Btn_navy_gradient"
              />
              <input
                className="Btn_navy gradient red"
                type="button"
                value="Btn_navy_gradient"
              />
              <input
                className="Btn_navy w80 blue"
                type="button"
                value="Btn_w80"
              />
              <input
              ...
              />
              <input
                className="Btn_navy w80 red"
                type="button"
                value="Btn_w80"
              />
              <input
                className="Btn_navy w72 light-gray"
                type="button"
                value="Btn_w72"
              />
              <input
                  ...
                  <li className="on">
                    ...
                    <div className="con-area">
                      <p className="qna_cont">
                        ...
                        연휴로 인하여 2021년 2월 11일(목)부터 13일(일)까지
                        휴무인 점 안내해드립니다. 2021년에도 밝은 희망이 넘치고
                        행복한 기운이 가득한 한해가 되시길 기원합니다. 새해 복
                        많이 받으세요! 운영팀 드림.
                      </p>
                    </div>
                  </li>
